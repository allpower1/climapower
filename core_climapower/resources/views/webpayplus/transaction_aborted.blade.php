    ...
    <div class="container">
        <div class="col-md-12 mx-auto">
            <div class="login-form">
                <h1 class="page_title" style="font-size: 50px;">Transacción abortada</h1>
                <div class="page_info">
                    <h3 class="page_subtitle">Oops...</h3>
                    <p class="page_description">Transacción Webpay Plus abortada desde el formulario Webpay.</p>
