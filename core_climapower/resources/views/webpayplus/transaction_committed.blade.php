    ...
    <div class="container">
        <div class="col-md-12 mx-auto">
            <div class="login-form">
                <h1 class="page_title" style="font-size: 50px;">Transacción Webpay Plus Confirmada</h1>
                <div class="page_info">
                    <h4 class="page_subtitle">ESTADO</h4>
                    @if ($resp->isApproved())
                        <p class="page_description">Transacción aprobada</p>
                    @else
                        <p class="page_description">Transacción rechazada</p>
                    @endif
