...
<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
    ...
    <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
        <!--begin::Logo image-->
        <a href="{{ url('/') }}">
            <img alt="Logo" src="{{ url('img/logoclimapower.png') }}" class="h-50px app-sidebar-logo-default" width="150" height="20"/>
            <img alt="Logo" src="{{ url('img/logoclimapower.png') }}" class="h-50px app-sidebar-logo-minimize" width="150" height="20"/>
        </a>
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ ($request->segment(2) == 'nuestrasestrategias' || $request->segment(2) == 'preguntasfrecuentes' || $request->segment(2) == 'experiencias' || $request->segment(2) == 'nuestroequipo' || $request->segment(2) == 'acercanosotros' || $request->segment(2) == 'sliderhome' || $request->segment(2) == 'testimonios' || $request->segment(2) == 'nuestros_proyectos' || $request->segment(2) == 'adminsitioweb' || $request->segment(2) == 'avisolegal' || $request->segment(2) == 'servicios')?'show':'' }}">
                        <!--begin:Menu link-->
                        <span class="menu-link">
                            <span class="menu-icon">
                        ...
                        <!--end:Menu sub-->
                        <!--begin:Menu sub servicios-->
                        <div class="menu-sub menu-sub-accordion">
                            <!--begin:Menu item-->
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ ($request->segment(1) == 'admin' and $request->segment(2) == 'servicios')?'active':'' }}" href="{{ url('admin/servicios') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ ($request->segment(1) == 'admin' and $request->segment(2) == 'acercanosotros')?'active':'' }}" href="{{ url('admin/acercanosotros') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ ($request->segment(1) == 'admin' and $request->segment(2) == 'testimonios')?'active':'' }}" href="{{ url('admin/testimonios') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Testimonios</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <!--end:Menu sub-->
                        <!--begin:Menu sub nuestros proyectos -->
                        <div class="menu-sub menu-sub-accordion">
                            <!--begin:Menu item-->
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ ($request->segment(1) == 'admin' and $request->segment(2) == 'nuestros_proyectos')?'active':'' }}" href="{{ url('admin/nuestros_proyectos') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Nuestros Proyectos</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                            <!--end:Menu item-->
                        ...
                        <!--end:Menu sub-->
                        <!--begin:Menu sub admin footer -->
                        <div class="menu-sub menu-sub-accordion">
                            <!--begin:Menu item-->
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link {{ ($request->segment(1) == 'admin' and $request->segment(2) == 'adminsitioweb')?'active':'' }}" href="{{ url('admin/adminsitioweb') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
