...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Admin Sitio Footer</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Admin Sitio Footer</li>
    </ul>
</div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Listado de Secciones Sitio Footer</h4>
                    <div class="panel-body table-responsive">
                        <table id="tabla_general_datatable_roles" class="table table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                @if (count($adminsitiowebs) > 0)
                                @foreach ($adminsitiowebs as $foot)
                                <tr class="trfilasroles" data-entry-id="{{ $foot->id }}">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ url('admin/adminsitioweb/editar',$foot->id) }}" class="btn btn-sm btn-info">@lang('global.app_edit')</a>
                                    </td>
                                </tr>
                                @endforeach
                                @endif
