...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Roles</h1>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                        $mensaje_alerta = "¿Estás seguro que deseas eliminar este rol?";
                    ?>
                    <div class="panel-body table-responsive">
                        <table id="tabla_general_datatable_roles" class="table table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr class="trfilasroles" data-entry-id="{{ $role->id }}">
