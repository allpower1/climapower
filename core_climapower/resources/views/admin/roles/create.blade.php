...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Crear Rol</h1>
...
@section('content')
    {!! Form::open(['method' => 'POST','route' => ['admin.roles.store'], 'autocomplete' => 'off','class' => 'form-horizontal']) !!}
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <input type="hidden" id="cantidadpermisos" value="{{ count($permissions) }}">
                            ...
                            <div class="col-sm-4">
                                <select name="permissiona[]" id="multiselect" class="form-control" size="20" multiple="multiple">
                                    <?php if($permissions){ foreach ($permissions as $perm) { ?>
                            ...
                            <div class="col-sm-4">
                                <select name="permission[]" id="multiselect_to" class="form-control" size="20" multiple="multiple"></select>
                                <div class="row">
                                    <div class="col-xs-6">
