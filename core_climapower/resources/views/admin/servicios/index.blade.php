...
<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
    <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Servicios</h1>
    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <li class="breadcrumb-item text-muted">Servicios</li>
    </ul>
</div>
@endsection
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php
                        $mensaje_alerta = "¿Estás seguro que deseas eliminar este servicio?";
                    ?>
                    <div class="panel-body table-responsive">
                        <table id="tabla_general_datatable_roles" class="table table-bordered nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr class="trfilasroles" data-entry-id="{{ $servicio->id }}">
                                    ...
                                    <td style="text-align: center;">{{ $servicio->titulo }}</td>
                                    <td style="text-align: center;"><?php if($servicio->descripcion != '' && $servicio->descripcion != null) echo "SI"; else echo "NO"; ?></td>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="{{ route('admin.servicios.edit',[$servicio->id]) }}" class="btn btn-sm btn-info">@lang('global.app_edit')</a>
                                        {!! Form::open(array(
