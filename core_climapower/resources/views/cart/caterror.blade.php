        ...
        <div class="col-md-12 mx-auto">
            <center>
                <div class="login-form">
                    <h1 class="page_title" style="font-size: 50px;">Error en la compra</h1>
                    <div class="page_info">
                        <p class="page_description">Favor intentar nuevamente</p>
                        <br>
                        <a href="{{ url('/cart-checkout') }}" class="btn btn-primary go_home theme-btn" style="width: 200px;">Ir al Carro</a>
