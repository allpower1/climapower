...
<section class="section-secondary custom-section-padding">
	<div class="container">
				...
				<div class="owl-carousel show-nav-title custom-dots-style-1 custom-dots-position custom-xs-arrows-style-2 mb-0" data-plugin-options="{'items': 4, 'margin': 20, 'autoHeight': true, 'loop': false, 'nav': false, 'dots': true}">
					...
					<div>
						<div class="team-item p-0">
							<a href="#" class="text-decoration-none">
								<span class="image-wrapper">
									<img src="{{ url('img/demos/business-consulting/team/team-2.jpg') }}" alt="" class="img-fluid" />
								</span>
							</a>
							<div class="team-infos">
								<div class="share">
					...
					<div>
						<div class="team-item p-0">
							<a href="#" class="text-decoration-none">
								<span class="image-wrapper">
									<img src="{{ url('img/demos/business-consulting/team/team-3.jpg') }}" alt="" class="img-fluid" />
								</span>
							</a>
							<div class="team-infos">
								<div class="share">
					...
					<div>
						<div class="team-item p-0">
							<a href="#" class="text-decoration-none">
								<span class="image-wrapper">
									<img src="{{ url('img/demos/business-consulting/team/team-4.jpg') }}" alt="" class="img-fluid" />
								</span>
							</a>
							<div class="team-infos">
								<div class="share">
					...
					<div>
						<div class="team-item p-0">
							<a href="#" class="text-decoration-none">
								<span class="image-wrapper">
									<img src="{{ url('img/demos/business-consulting/team/team-5.jpg') }}" alt="" class="img-fluid" />
								</span>
							</a>
							<div class="team-infos">
								<div class="share">
		...
		<div class="row text-center mt-5">
			<div class="col">
				<a class="btn btn-outline custom-border-width btn-primary custom-border-radius font-weight-semibold text-uppercase" href="#">View All</a>
			</div>
		</div>
	</div>
</section>
