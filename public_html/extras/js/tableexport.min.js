...
(this,function(t,e,r,o){
	...
	function c(t){
		var e;
		switch(t){
			case v.TXT:case v.CSV:case v.XLS:e=!0;
			break;
			default:e=b(t)
		}return e
	}
	...
	var d=function(t,e){
		...
		r.getExportData=function(){
			...
			e.rows=a(t.querySelectorAll("tbody > tr")),e.rows=o.headers?a(t.querySelectorAll("thead > tr")).concat(e.rows):e.rows,e.rows=o.footers?e.rows.concat(a(t.querySelectorAll("tfoot > tr"))):e.rows,e.thAdj=o.headers?t.querySelectorAll("thead > tr").length:0,e.filename="id"===o.filename?t.getAttribute("id")?t.getAttribute("id"):r.defaultFilename:o.filename?o.filename:r.defaultFilename,e.uuid=w(t),e.checkCaption=function(e){
				...
				return function(t){
					var r=h.getInstance().getItem(t),o=t.substring(t.indexOf("-")+1);
					i[e.uuid]=i[e.uuid]||{},i[e.uuid][o]=JSON.parse(r)
				}
			}(),e.rcMap=(new m).build(e,o);
			var n=y.reduce(function(t,e){
				return t[e]=0,t
			},{});
			o.formats.forEach(function(t){
				return p(t)?c(t)?void(n[t]||(e.setExportData(r.exporters.build.call(r,e,t)),n[t]++)):u('"'+t+'" requires "js-xlsx".'):u('"'+t+'" is not a valid format. \nFormats: '+y.join(", "))
			})
		});
	...
	d.prototype={
		...
		build:function(t,e){
			var r=this,o=r.settings,n=r.formatConfig[e],i=n.separator,s=t.rcMap,l=function(t){
				if(b(e))
					return{
						v:o.formatValue(t.textContent),t:r.getType(t.className)
					};
					switch(e){
						case v.CSV:return'"'+o.formatValue(t.textContent.replace(/"/g,'""'))+'"';
						default:return o.formatValue(t.textContent)
					}
			},p=a(t.rows).map(function(t,r){
				if(s.isIgnore(r))
					return s.handleRowColMapProp(s.TYPE.IGNORE);
				if(s.isEmpty(r))
					return s.handleRowColMapProp(s.TYPE.EMPTY);
			...
			}).processRows(e,r.rowDel),c=JSON.stringify({data:p,filename:t.filename,mimeType:n.mimeType,fileExtension:n.fileExtension,merges:s.merges}),u=x({uuid:t.uuid,type:e});
			return o.exportButtons&&t.checkCaption(r.createObjButton(u,c,n.buttonContent,n.defaultClass,o.bootstrapSettings)),h.getInstance().setItem(u,c,!0)
		}
	},createObjButton:function(t,e,r,o,n){
		var a=document.createElement("button");
		return a.setAttribute(this.storageKey,t),a.className=n.bootstrapClass+n.bootstrapTheme+o,a.textContent=r,a
	},escapeHtml:function(t){
		var e=this;
		return String(t).replace(/[&<>'\/]/g,function(t){return e.entityMap[t]})
		...
		for(var r={},n={s:{c:1e7,r:1e7},e:{c:0,r:0}},a=this.typeConfig,i=0;i!==t.length;++i)
		...
		var e=t.target,r=JSON.parse(h.getInstance().getItem(e.getAttribute(this.storageKey))),o=r.data,n=r.filename,a=r.mimeType,i=r.fileExtension,s=r.merges;
		...
		if(t=this.getRawData(t,a,n,i),g){
			var s="data:"+o+";"+this.charset+","+t;this.downloadDataURI(s,n,a)
		...
		if(b(a)){
			...
			var p={bookType:l,bookSST:!1,type:"binary"},c=o.write(i,p);
			t=this.string2ArrayBuffer(c)
		}return t
...
var h=function(){
	this._instance=null,this.store=sessionStorage,this.namespace=d.prototype.defaultNamespace,this.getKey=function(t){
		...
		var o=this.getKey(t);
		if(!this.exists(t)||r)
			return"string"!=typeof e?u('"value" must be a string.'):(this.store.setItem(o,e),t)
