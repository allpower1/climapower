!function (s) {
    ...
    function o(e) {
        1 == s("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (s("#dark-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "extras/assets/css/bootstrap.min.css"), s("#app-style").attr("href", "extras/assets/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == s("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (s("#light-mode-switch").prop("checked", !1), s("#rtl-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "assets/css/bootstrap-dark.min.css"), s("#app-style").attr("href", "assets/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == s("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (s("#light-mode-switch").prop("checked", !1), s("#dark-mode-switch").prop("checked", !1), s("#bootstrap-style").attr("href", "extras/assets/css/bootstrap.min.css"), s("#app-style").attr("href", "assets/css/app-rtl.min.css"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
    function l() {
    ...
    s("#side-menu").metisMenu(), s("#vertical-menu-btn").on("click", function (e) {
        ...
        //validar que clase tiene el body
        if(s("body").hasClass("vertical-collpsed")){
            s("#iconomenuocultar").addClass('fa-caret-right');
            s("#iconomenuocultar").removeClass('fa-caret-left');
        }else{
            s("#iconomenuocultar").removeClass('fa-caret-right');
            s("#iconomenuocultar").addClass('fa-caret-left');
        }
    }), s("#sidebar-menu a").each(function () {
        var e = window.location.href.split(/[?#]/)[0]; this.href == e && (s(this).addClass("active"), s(this).parent().addClass("mm-active"), s(this).parent().parent().addClass("mm-show"), s(this).parent().parent().prev().addClass("mm-active"), s(this).parent().parent().parent().addClass("mm-active"), s(this).parent().parent().parent().parent().addClass("mm-show"), s(this).parent().parent().parent().parent().parent().addClass("mm-active"))
